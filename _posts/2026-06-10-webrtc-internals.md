...
image:
  path: /assets/img/posts/webrtc-internals/webrtc-connection-flow.png
  alt: "WebRTC 연결 전체 흐름"
---
...
![STUN vs TURN — ICE 경로 후보 수집 방식](/assets/img/posts/webrtc-internals/stun-vs-turn.png) 연결 가능한 경로 후보들을 모아서 하나씩 시도해보는 방식이다.
